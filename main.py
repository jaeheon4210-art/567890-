...
# ==========================================
# 📌 구역 8: 스크린 독점 대비 10위권 체류력 (산점도)
# ==========================================
st.header("🎯 섹션 8. 스크린을 많이 쥐면 10위권에서도 오래 버틸까?")
...
fig8 = px.scatter(
    ...
    color="genre",
    hover_name="movieNm",
    title="스크린을 많이 쥐면 10위권에서도 오래 버틸까?",
    labels={
        "first_scrn": "개봉일 스크린수 (개)",
...
fig8.update_traces(
    hovertemplate="<b>영화명:</b> %{hovertext}<br><b>개봉일 스크린수:</b> %{x:,}개<br><b>10위권 머문 날수:</b> %{y}일<extra></extra>"
)
...
st.info(
    "💡 **이 그래프로 알 수 있는 것:** "
    "초기 스크린 확보량이 많더라도 흥행 지속력(상위권 체류 일수)과 항상 비례하지는 않으며, "
    "적은 스크린으로 시작해 입소문만으로 장기 집권에 성공한 작품과 초반 물량 공세 대비 빠르게 순위권 밖으로 밀려난 작품의 대조를 확인할 수 있음."
)
